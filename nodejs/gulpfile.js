...
gulp.task('default', function(callback){
	runSequence(['sass', 'jslibs', 'es6', 'images', 'fonts', 'html', 'browserSync', 'watch'], callback )
});
...
gulp.task('watch', function(){
	...
	gulp.watch('client/src/*.html', ['browserSync', 'html']);
});
...
gulp.task('images', function(){
	return gulp.src('client/src/assets/**/*.+(png|jpg|gif|svg|mp4|ogv|ogg|bin|gltf)')
